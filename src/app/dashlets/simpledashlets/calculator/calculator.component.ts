...
export class CalculatorComponent extends DashletBaseComponent implements OnInit {
    ...
    expression: string = ''
    OldResult: string = this.StoredData;;
    ...
    evaluate() {
        ...
        this.flipACButton(false);
        this.SaveContentState(this.expression)
    ...
    ngOnInit(){
        setTimeout(() => {
            this.expression=this.items[this.index].OldData ;
        }, 1);
