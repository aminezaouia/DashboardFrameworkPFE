...
const DashboardGridsterConfig:GridsterConfig={
  ...
  fixedColWidth: 2500, // fixed col width for gridType: 'fixed'
  fixedRowHeight: 2500, // fixed row height for gridType: 'fixed'
 ...
 // minItemArea: 1, // min item area: cols * rows
  ...
  emptyCellDragMaxRows: 500, // limit empty cell drag max rows
